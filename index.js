...
les tests,
la bonne pratique : 
une fonction qui a une valeur retour afin d'éviter les effets
...
// il est impossible d'utiliser une variable en dehors de la fonction
...
//On peut remplacer if et else par du ternaire ( => if = true = ?)  (else = false = :)
//L'opérateur ternaire est un raccourci pour écrire une condition
//et else = false = :
